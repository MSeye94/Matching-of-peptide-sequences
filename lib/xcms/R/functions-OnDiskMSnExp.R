...
.obiwarp <- function(object, param) {
    ...
    message("\n Sample number ", centerSample(param), " used as center sample.")
  ...
  res <- bplapply(objL, function(z, cntr, cntrPr, parms) {
    message("\n Aligning ", basename(fileNames(z)), " against ",
